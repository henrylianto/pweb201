...
<head>
  ...
  <link rel="stylesheet" href="css/style-changes.css">
  <title>Program03</title>
</head>
  <body>
    <div class="container">
      <nav class"navigasi">
        <button type="button" name="Beranda"><a class="navlink" href="program03.php">Beranda</a></button>
      </nav>
      <div class="row">
        <div class="col6">
          <table>
        ...
        <div class="col6">
          ...
          <table>
            ...
            <tr>
              <td class="fieldbot">Pembimbing Akademik</td>
              <td class="data">
